...
# Example it matches: "Availability Zone: ap-southeast-1b"
AZ_REGEX = re.compile(r"Availability\s+Zone:\s*([A-Za-z0-9-._]+)", re.IGNORECASE)

# Regex to extract the Private IP after the label "Private IP Address:"
# Example it matches: "Private IP Address: 10.10.12.239"
IP_REGEX = re.compile(r"Private\s+IP\s+Address:\s*([0-9.]+)", re.IGNORECASE)
